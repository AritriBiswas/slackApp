...
//   const [loading, setLoading] = useState(false)
  ...
  return (
    <Container>
        ...
        <Body2>
          <Body3>
            <h1 style={{padding: '1px 49234pxpx 0px'}} className="text-center mb-4">Set up your digital HQ</h1>
            <p style={{padding: '12px 17px 5px 91px'}} className="text-center mb-4">Slack gives your team a home – a place where they can talk and work together. To create a new workspace, click on the button below.</p>
            <submit  onClick={handleClick} style={{backgroundColor : 'purple', padding:'15px 37px 15px 37px', margin:'7px', color: 'white', 'border-radius': '4px', "font-weight": "bold", width: '136px'}} className="w-100 " type="submit">
              Create a workspace
          </submit>
          </Body3>
